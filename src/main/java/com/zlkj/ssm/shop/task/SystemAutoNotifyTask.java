...
import com.zlkj.ssm.shop.manage.service.AdminEmailNotifyProductService;
...
public class SystemAutoNotifyTask implements Runnable {
	...
	@Autowired
	private AdminEmailNotifyProductService emailNotifyProductService;

	public void setEmailNotifyProductService(
			AdminEmailNotifyProductService emailNotifyProductService) {
...
//		AdminEmailNotifyProductService emailNotifyProductService = (AdminEmailNotifyProductService) app.getBean("emailNotifyProductServiceManage");
