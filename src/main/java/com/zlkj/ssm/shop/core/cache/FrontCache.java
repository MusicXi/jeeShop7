...
import com.zlkj.ssm.shop.front.entity.Advert;
...
import com.zlkj.ssm.shop.front.entity.CommentType;
import com.zlkj.ssm.shop.front.entity.Express;
import com.zlkj.ssm.shop.front.entity.IndexImg;
import com.zlkj.ssm.shop.front.entity.Keyvalue;
...
import com.zlkj.ssm.shop.front.entity.Pay;
import com.zlkj.ssm.shop.front.entity.Product;
import com.zlkj.ssm.shop.front.entity.ProductStockInfo;
import com.zlkj.ssm.shop.front.service.AdvertService;
import com.zlkj.ssm.shop.front.service.AreaService;
import com.zlkj.ssm.shop.front.service.AttributeService;
import com.zlkj.ssm.shop.front.service.CatalogService;
import com.zlkj.ssm.shop.front.service.CommentService;
import com.zlkj.ssm.shop.front.service.CommentTypeService;
import com.zlkj.ssm.shop.front.service.ExpressService;
import com.zlkj.ssm.shop.front.service.IndexImgService;
import com.zlkj.ssm.shop.front.service.KeyvalueService;
import com.zlkj.ssm.shop.front.service.NavigationService;
import com.zlkj.ssm.shop.front.service.NewsService;
import com.zlkj.ssm.shop.front.service.NotifyTemplateService;
import com.zlkj.ssm.shop.front.service.OrderService;
import com.zlkj.ssm.shop.front.service.PayService;
...
import com.zlkj.ssm.shop.manage.entity.Hotquery;
import com.zlkj.ssm.shop.manage.service.AdminAccountRankService;
import com.zlkj.ssm.shop.manage.service.AdminActivityService;
import com.zlkj.ssm.shop.manage.service.AdminHotqueryService;
...
public class FrontCache {
    ...
    @Autowired
	private AdminAccountRankService accountRankService;
    @Autowired
	private AdminActivityService activityService;
    @Autowired
	private AdminHotqueryService hotqueryService;
    ...
    public AdminHotqueryService getHotqueryService() {
		return hotqueryService;
	}

	public void setHotqueryService(AdminHotqueryService hotqueryService) {
		this.hotqueryService = hotqueryService;
	}

	public AdminActivityService getActivityService() {
		return activityService;
	}

	public void setActivityService(AdminActivityService activityService) {
		this.activityService = activityService;
	}

	public AdminAccountRankService getAccountRankService() {
		return accountRankService;
	}

	public void setAccountRankService(AdminAccountRankService accountRankService) {
	...
	public void setSystemSettingService(
			AdminSystemSettingService systemSettingService) {
	...
	private List<Catalog> loadCatalogs2(String type){
		...
		if(catalogsList!=null){
			...
			for(Iterator<Catalog> it = catalogsList.iterator();it.hasNext();){
				...
				if(notEmpty(item.getPid()) && item.getPid().equals("0")){
					//是否在导航栏显示中文化
	...
	public void loadActivityScoreProductList(){
		...
		for(Iterator<Entry<String, Activity>> it = activityMap.entrySet().iterator();it.hasNext();){
			...
			if(entry.getValue().getActivityType().equals(Activity.activity_activityType_j) &&
					notEmpty(entry.getValue().getProductID())){
