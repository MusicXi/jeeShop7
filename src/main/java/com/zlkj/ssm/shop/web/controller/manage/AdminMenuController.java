...
import com.zlkj.ssm.shop.manage.service.impl.AdminPrivilegeServiceImpl;
...
public class AdminMenuController extends BaseController<Menu> {
    @Autowired
...
//	private static final String str = "../";
    ...
    public AdminPrivilegeServiceImpl getPrivilegeService() {
...
//				itemMenu.setMenuType(entry);
	...
	public AdminMenuServiceImpl getMenuService() {
		return menuService;
	}
