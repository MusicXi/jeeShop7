...
public abstract class BaseController<E extends PagerModel> {
    ...
    public String selectList(HttpServletRequest request, @ModelAttribute("e") E e) throws Exception {
        ...
        request.setAttribute("pageNo",(offset/ pager.getPageSize())+1);
        return page_toList;
    }
...
//    }
    ...
    protected String getUrl(HttpServletRequest request)throws Exception{
		return request.getScheme() + "://" + (80 == request.getServerPort() ? request.getServerName()
				: request.getServerName() + ":" + request.getServerPort());
	}
	protected String getDomain(HttpServletRequest request)throws Exception{
		return 80 == request.getServerPort() ? request.getServerName()
				: request.getServerName() + ":" + request.getServerPort();
	}
    
    protected  HttpServletRequest getRequest()throws ServletException, IOException {
    ...
    protected  HttpSession getSession()throws ServletException, IOException{
        return ((ServletRequestAttributes) RequestContextHolder.getRequestAttributes()).getRequest().getSession(true);
    }
    protected  HttpSession getSession(boolean create)throws ServletException, IOException{
