...
import com.zlkj.ssm.shop.core.entity.MenuItem;
...
import com.zlkj.ssm.shop.manage.service.impl.AdminUserServiceImpl;
...
public class AdminUserController extends BaseController<User> {
	private static final org.slf4j.Logger logger = LoggerFactory.getLogger(AdminUserController.class);
    ...
    @Resource
	private AdminSystemlogService systemlogService;
    @Resource
	...
	public AdminUserServiceImpl getUserService() {
		return userService;
	}

	public void setUserService(AdminUserServiceImpl userService) {
	...
	public void setSystemlogService(AdminSystemlogService systemlogService) {
		this.systemlogService = systemlogService;
	}
	@RequestMapping("/loadFreemarker")
	public String loadFreemarkerView()throws Exception{
		System.out.println("-----------加载Freemarker模板------>>>>>");
	...
	public String login(HttpSession session,@ModelAttribute("e") User e, ModelMap model) throws Exception {
		...
		User u = ((AdminUserServiceImpl)getService()).login(e);
		if (u == null) {
